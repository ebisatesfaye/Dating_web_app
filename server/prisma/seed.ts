import { PrismaClient, Role, Gender, PaymentStatus, RelationshipPreference } from '@prisma/client';
    ...
    data: {
      ...
      profile: {
        create: {
          ...
          isActive: true,
          relationshipPreference: RelationshipPreference.RELATIONSHIP,
        },
      },
    },
  });
    ...
    data: {
      ...
      profile: {
        create: {
          ...
          relationshipPreference: RelationshipPreference.DATING,
    ...
    data: {
      ...
      profile: {
        create: {
          ...
          relationshipPreference: RelationshipPreference.FWB,
    ...
    data: {
      ...
      profile: {
        create: {
          ...
          relationshipPreference: RelationshipPreference.CASUAL,
